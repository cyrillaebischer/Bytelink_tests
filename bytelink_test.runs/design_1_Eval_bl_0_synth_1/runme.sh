...
HD_PWD='C:/Users/Cyrill/Documents/S6/BA-GULFstream/bytelink_test_shivang/bytelink_test/bytelink_test.runs/design_1_Eval_bl_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_Eval_bl_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_Eval_bl_0.tcl
