...
proc create_root_design { parentCell } {
  ...
  set GULF_dataIn [ create_bd_port -dir I GULF_dataIn ]
  ...
  connect_bd_net -net GULF_bl_dataOut [get_bd_pins Eval_bl/dataIn] [get_bd_pins GULF_bl/dataIn] [get_bd_pins GULF_bl/dataOut]
